function [overlap] = check_overlap_ellipses(lnk,circles,dlnk,nglnk,ndxy,image_size,x0,y0,a0,b0,theta0,threshold,threshold2)
...
for k = 1:length(b)
    ...
    overlap = overlap_ellipses(x0,y0,a0,b0,theta0,x1,y1,a1,b1,theta1,threshold,threshold2);
